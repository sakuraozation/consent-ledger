# 07 — showing her where it was used

## Instruction

> Her complaint was that she cannot tell when it happens. The screens so far only show
> what she agreed to, which solves half the problem.
>
> Record every check — allow, deny, ask and revoked alike — and show it on her page. The
...
later request for that person**, because the revocation check ran across all of her
...
loud in the pitch: the feature that shows her what happened is also what showed us what
we got wrong.
